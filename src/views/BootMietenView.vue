...
onMounted(async () => {
  const response = await axios.get('http://localhost:3000/boats.json');
  if(response) {
...
//   },
//   {
//     title: 'Chaparral SunCoast 250/300HP',
//     price: 875,
//     image: boat2Image,
//     capacity: 14,
//     length: '24ft',
